...
const Configuration = () => {
    ...
    async function checkout(){
        await AsyncStorage.removeItem("idUser@foodEntregador")
        await AsyncStorage.removeItem("nameUser@foodEntregador")
        await AsyncStorage.removeItem("emailUser@foodEntregador")
        await AsyncStorage.removeItem("foneUser@foodEntregador")
