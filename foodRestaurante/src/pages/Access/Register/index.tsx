    ...
    async function cadastrar() {
        ...
        if (key === keyAgain) {
            ...
            if (key.length > 5) {
                ...
                ["idUser@foodRestaurante", String(user._id)],
                ["nameUser@foodRestaurante", String(user.name)],
                ["emailUser@foodRestaurante", String(user.email)],
                ["foneUser@foodRestaurante", String(user.fone)]
                ])
